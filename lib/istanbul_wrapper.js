...
class IstanbulWrapper {
    constructor() {
        ...
        this.coverageJson = `${this.tmpDir}/coverage.json`;
    }
    ...
    */
    instrument(tmpSrc, realSrc) {
        ...
        // need to capture global.__coverage__ from app.js file
        if (tmpSrc.endsWith('/app.js')) {
            ic += '\n';
            ic += `setTimeout(function() { require("fs").writeFileSync("${this.coverageJson}", JSON.stringify(global.__coverage__));\nprocess.exit(); }, 20000);`;
        }
